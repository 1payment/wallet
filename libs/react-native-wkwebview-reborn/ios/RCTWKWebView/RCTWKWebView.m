...
- (void)loadRequest:(NSURLRequest *)request
{
  ...
  if (@available(iOS 11.0, *)) {
    ...
    NSMutableString *rules = [[NSMutableString alloc] initWithString:@"[{"];
    [rules appendString:@"\"trigger\": {\"url-filter\": \"(mixpanel)\", \"resource-type\": [\"script\"]},\"action\": {\"type\": \"block\"}},"];
    [rules appendString:@"{\"trigger\": {\"url-filter\": \"((analytics))\",\"resource-type\": [\"script\"]},\"action\": {\"type\": \"block\"}}]"];
